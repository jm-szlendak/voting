...
Selector labels
*/}}
{{- define "voting-worker.selectorLabels" -}}
...
*/}}
{{- define "voting-worker.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "voting-worker.fullname" .) .Values.serviceAccount.name }}
{{- else }}
